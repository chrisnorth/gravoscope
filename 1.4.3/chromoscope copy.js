...
(function ($) {
	...
	Chromoscope.prototype.getLanguage = function(lang){
        ...
        //console.log('Language: ',this.dir,lang);
	}
	...
	Chromoscope.prototype.buildHelp = function(overwrite){
		...
		// }
        $(this.body+" .chromo_help .chromo_close").bind('click',{id:'.chromo_help'}, jQuery.proxy( this, "hide" ));
